        ...
        <div class="grade-produtos">
            @forelse($products as $product)
                <div class="card-produto">
                    <div class="id-produto">#{{ str_pad($product->id, 3, '0', STR_PAD_LEFT) }}</div>
                    ...
                    <div class="info-produto">
                        <div class="acoes-card">
                            ...
                            <form method="POST" action="{{ route('admin.produtos.destroy', $product->id) }}" style="display: inline;" onsubmit="return confirm('Tem certeza que deseja excluir este produto? Esta ação não pode ser desfeita.')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="acao-link" style="border: none; background: none; padding: 0; cursor: pointer;">
