                    ...
                    <div class="secao-conta">
                        ...
                        <div class="campos-usuario">
                            <div class="campo-exibicao">
                                ...
                                <span
                                    class="valor-campo">{{ auth()->user()->full_name ?? 'Preencha seu nome completo' }}</span>
                            </div>
                            <div class="campo-exibicao">
                    ...
                    <div class="secao-endereco">
                        ...
                        <div class="campos-usuario">
                            @if (auth()->user()->address)
                                <div class="campo-exibicao">
                                    <span class="valor-campo">{{ auth()->user()->address->street }},
                                        {{ auth()->user()->address->number }}</span>
                                </div>
                                <div class="campo-exibicao">
                ...
                <div class="lista-pedidos">
                                    ...
                                    <div class="detalhes-pedido">
                                        <div class="coluna-info">
                                            <div class="status-pedido">
                                                <span
                                                    class="badge-status badge-{{ $order->status }}">{{ ucfirst($order->status) }}</span>
                                            </div>
                                            <div class="total-pedido">R$
                                                {{ number_format($order->total_amount, 2, ',', '.') }}</div>
                                            <a href="{{ route('user.orders.show', $order->id) }}"
                                                class="botao-acompanhar">VER DETALHES</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    @empty
                        <div class="mensagem-vazia">
                            ...
                            <a href="{{ route('client.produtos.index') }}" class="botao-comprar-agora">COMEÇAR A
                                COMPRAR</a>
                        </div>
                    @endforelse
                </div>
